insert into category (body) values ('SEDAN'), ('WAGON'), ('HATCHBACK'), ('CROSSOVER'), ('COUPE')

insert into car_showroom (name_of_showroom, address_of_showroom)
values ('Лозанж Lada', 'просп. Дзержинского, 134'), ('Атлант-М Сухарево', 'ул. Шаранговича, 22, корп. 1')

insert into client (date_of_registration, name_of_customer)
values ('2022-12-25', 'Иванов Иван Иванович'), ('2024-12-03', 'Сидоров Сидор Сидорович'), ('2021-03-16', 'Петров Петр Петрович')

insert into contact (client_id, contacts)
values (1, 'Минск, просп. Мира, 1 этаж 1'), (2, 'Минск, Аэродромная ул., 30, 8 этаж'), (3, 'Минск, ул. Николы Теслы, 18')

insert into car (price, year, car_showroom_showroom_id, category_id, car_brand, car_model)
...
insert into review (rating, car_id, client_id, text_review)
